...
class SetTradingStopParams(TypedDict, total=False):
    ...
    take_profit: Optional[float]  # need to str
    stop_loss: Optional[float]  # need to str
    trailing_stop: Optional[float]  # need to str
    tp_trigger_by: Optional[TpSlTriggerBy]
    sl_trigger_by: Optional[TpSlTriggerBy]
    active_price: Optional[float]  # need to str

    # Partial mode fields
    tp_size: Optional[float]  # need to str
    sl_size: Optional[float]  # need to str
    tp_limit_price: Optional[float]  # need to str
    sl_limit_price: Optional[float]  # need to str
    tp_order_type: Optional[TpSlOrderType]
    sl_order_type: Optional[TpSlOrderType]
...
class PlaceOrderParams(TypedDict, total=False):
    ...
    market_unit: Optional[MarketUnit]
    ...
    price: Optional[float]  # need to str
    ...
    position_idx: Optional[PositionIdx]
