...
from aiobybit.session import BybitSessionManager
...
async def benchmark_session_manager_scenarios(
    ...
    clients_without_session: List[BybitHttpClient] = []
    ...
    clients_with_session: List[BybitHttpClient] = []
    for i in range(client_count):
        client = BybitHttpClient(
...
async def main() -> None:
    ...
    print("BybitSessionManager Performance Benchmark")
